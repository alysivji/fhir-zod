...
function collectReferencedDefinitionNames(
	...
	if (name.includes("_")) {
		...
		if (
			directTypeCode === "BackboneElement" ||
			directTypeCode === "BackboneType" ||
			directTypeCode === "Element"
		) {
...
function normalizeStructureType(
	...
	if (
		(normalizedCode === "BackboneElement" ||
			normalizedCode === "BackboneType" ||
			normalizedCode === "Element") &&

// Source: https://hl7.org/fhir/STU3/documentmanifest.html
...
import { DocumentManifest_ContentSchemaInternal } from "./DocumentManifest_Content";
...
const getDocumentManifest_ContentSchema =
  (): z.ZodType<DocumentManifest_Content> =>
...
/** @internal */
export const DocumentManifestSchemaInternal = z
  .object({
    author: z.lazy(getReferenceSchema).array().optional(),
    contained: z.lazy(getFhirResourceSchema).array().optional(),
    content: z.lazy(getDocumentManifest_ContentSchema).array(),

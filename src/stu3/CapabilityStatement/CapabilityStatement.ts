// Source: https://hl7.org/fhir/STU3/capabilitystatement.html
...
export interface CapabilityStatement extends DomainResource {
  ...
  acceptUnknown: "both" | "elements" | "extensions" | "no";
...
/** @internal */
export const CapabilityStatementSchemaInternal = z
  .object({
    acceptUnknown: z.enum(["both", "elements", "extensions", "no"]),
    _acceptUnknown: z.lazy(getElementSchema).optional(),
    ...
    implementation: z
      ...
      .optional(),
    implementationGuide: fhirUri().nullable().array().optional(),

// Source: https://hl7.org/fhir/STU3/capabilitystatement-definitions.html#CapabilityStatement.rest
...
import type { CapabilityStatement_Rest_Operation } from "./CapabilityStatement_Rest_Operation";
import { CapabilityStatement_Rest_OperationSchemaInternal } from "./CapabilityStatement_Rest_Operation";
...
export interface CapabilityStatement_Rest extends BackboneElement {
  ...
  operation?: Array<CapabilityStatement_Rest_Operation>;
...
const getCapabilityStatement_Rest_OperationSchema =
  (): z.ZodType<CapabilityStatement_Rest_Operation> =>
...
export const CapabilityStatement_RestSchemaInternal =
  BackboneElementSchemaInternal.extend({
    compartment: fhirUri().nullable().array().optional(),
    ...
    operation: z
      .lazy(getCapabilityStatement_Rest_OperationSchema)
      .array()
      .optional(),
    resource: z

// Source: https://hl7.org/fhir/STU3/encounter.html
...
/** @internal */
export const EncounterSchemaInternal = z
  .object({
    account: z.lazy(getReferenceSchema).array().optional(),
    appointment: z.lazy(getReferenceSchema).optional(),
    class: z.lazy(getCodingSchema).optional(),

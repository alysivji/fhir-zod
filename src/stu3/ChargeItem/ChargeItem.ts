// Source: https://hl7.org/fhir/STU3/chargeitem.html
...
import { ChargeItem_ParticipantSchemaInternal } from "./ChargeItem_Participant";
...
export interface ChargeItem extends DomainResource {
  ...
  participant?: Array<ChargeItem_Participant>;
...
const getChargeItem_ParticipantSchema = (): z.ZodType<ChargeItem_Participant> =>
...
/** @internal */
export const ChargeItemSchemaInternal = z
  .object({
    ...
    participant: z.lazy(getChargeItem_ParticipantSchema).array().optional(),

// Source: https://hl7.org/fhir/STU3/imagingstudy.html
...
export interface ImagingStudy extends DomainResource {
  ...
  procedureReference?: Array<Reference>;
...
export const ImagingStudySchemaInternal = z
  .object({
    accession: z.lazy(getIdentifierSchema).optional(),
    availability: z
      .enum([
        "109001",
        "109002",
      ...
      .optional(),
    _availability: z.lazy(getElementSchema).optional(),
    ...
    modalityList: z.lazy(getCodingSchema).array().optional(),
    ...
    procedureReference: z.lazy(getReferenceSchema).array().optional(),

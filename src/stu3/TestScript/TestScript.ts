// Source: https://hl7.org/fhir/STU3/testscript.html
...
import { TestScript_RuleSchemaInternal } from "./TestScript_Rule";
import type { TestScript_Ruleset } from "./TestScript_Ruleset";
import { TestScript_RulesetSchemaInternal } from "./TestScript_Ruleset";
...
export interface TestScript extends DomainResource {
  ...
  ruleset?: Array<TestScript_Ruleset>;
...
const getTestScript_RuleSchema = (): z.ZodType<TestScript_Rule> =>
  TestScript_RuleSchemaInternal as z.ZodType<TestScript_Rule>;
const getTestScript_RulesetSchema = (): z.ZodType<TestScript_Ruleset> =>
...
export const TestScriptSchemaInternal = z
  .object({
    ...
    rule: z.lazy(getTestScript_RuleSchema).array().optional(),
    ruleset: z.lazy(getTestScript_RulesetSchema).array().optional(),

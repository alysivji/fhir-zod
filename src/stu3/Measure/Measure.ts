// Source: https://hl7.org/fhir/STU3/measure.html
...
export const MeasureSchemaInternal = z
  .object({
    ...
    improvementNotation: fhirString().optional(),
    _improvementNotation: z.lazy(getElementSchema).optional(),
    ...
    set: fhirString().optional(),
    _set: z.lazy(getElementSchema).optional(),

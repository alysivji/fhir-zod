// Source: https://hl7.org/fhir/STU3/codesystem.html
...
export interface CodeSystem extends DomainResource {
  ...
  content: "complete" | "example" | "fragment" | "not-present";
...
/** @internal */
export const CodeSystemSchemaInternal = z
  .object({
    ...
    content: z.enum(["complete", "example", "fragment", "not-present"]),

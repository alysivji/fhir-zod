// Source: https://hl7.org/fhir/R4B/imagingstudy-definitions.html#ImagingStudy.series
...
export const ImagingStudy_SeriesSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    laterality: z.lazy(getCodingSchema).optional(),
    modality: z.lazy(getCodingSchema),

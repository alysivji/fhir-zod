// Source: https://hl7.org/fhir/R4B/researchdefinition.html
...
/** @internal */
export const ResearchDefinitionSchemaInternal = z
  .object({
    ...
    exposureAlternative: z.lazy(getReferenceSchema).optional(),
...
export const ResearchDefinitionSchema =
  ResearchDefinitionSchemaInternal as z.ZodType<ResearchDefinition>;

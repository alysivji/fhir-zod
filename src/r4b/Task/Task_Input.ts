// Source: https://hl7.org/fhir/R4B/task-definitions.html#Task.input
...
/** @internal */
export const Task_InputSchemaInternal = BackboneElementSchemaInternal.extend({

// Source: https://hl7.org/fhir/R5/specimen-definitions.html#Specimen.collection
...
export const Specimen_CollectionSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    device: z.lazy(getCodeableReferenceSchema).optional(),
    ...
    procedure: z.lazy(getReferenceSchema).optional(),

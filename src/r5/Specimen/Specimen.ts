// Source: https://hl7.org/fhir/R5/specimen.html
...
import type { Specimen_Feature } from "./Specimen_Feature";
import { Specimen_FeatureSchemaInternal } from "./Specimen_Feature";
...
export interface Specimen extends DomainResource {
  ...
  feature?: Array<Specimen_Feature>;
  /** Id for specimen. */
...
const getSpecimen_FeatureSchema = (): z.ZodType<Specimen_Feature> =>
...
export const SpecimenSchemaInternal = z
  .object({
    ...
    _combined: z.lazy(getElementSchema).optional(),
    ...
    feature: z.lazy(getSpecimen_FeatureSchema).array().optional(),
    id: fhirId().optional(),

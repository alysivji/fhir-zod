// Source: https://hl7.org/fhir/R5/measure.html
...
import type { Measure_Term } from "./Measure_Term";
import { Measure_TermSchemaInternal } from "./Measure_Term";
...
const getMeasure_TermSchema = (): z.ZodType<Measure_Term> =>
...
/** @internal */
export const MeasureSchemaInternal = z
  .object({
    ...
    supplementalData: z
      ...
      .array()
      .optional(),
    term: z.lazy(getMeasure_TermSchema).array().optional(),

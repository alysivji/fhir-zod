// Source: https://hl7.org/fhir/R5/transport-definitions.html#Transport.input
...
export interface Transport_Input extends BackboneElement {
...
/** @internal */
export const Transport_InputSchemaInternal =
...
export const Transport_InputSchema =

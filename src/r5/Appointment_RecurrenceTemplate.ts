...
export interface Appointment_RecurrenceTemplate extends BackboneElement {
	...
	_excludingDate?: Array<Element>;
	/** Any dates, such as holidays, that should be excluded from the recurrence. */
	excludingRecurrenceId?: Array<number>;
	/** Extensions for excludingRecurrenceId */
	_excludingRecurrenceId?: Array<Element>;
...
export const Appointment_RecurrenceTemplateSchemaInternal =
	BackboneElementSchemaInternal.extend({
		excludingDate: fhirDate().array().optional(),
		_excludingDate: z.lazy(getElementSchema).array().optional(),
		excludingRecurrenceId: z.number().int().positive().array().optional(),
		_excludingRecurrenceId: z.lazy(getElementSchema).array().optional(),
		...
		occurrenceDate: fhirDate().array().optional(),
		_occurrenceDate: z.lazy(getElementSchema).array().optional(),

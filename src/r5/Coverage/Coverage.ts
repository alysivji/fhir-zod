// Source: https://hl7.org/fhir/R5/coverage.html
...
import type { Coverage_PaymentBy } from "./Coverage_PaymentBy";
import { Coverage_PaymentBySchemaInternal } from "./Coverage_PaymentBy";
...
export interface Coverage extends DomainResource {
  ...
  paymentBy?: Array<Coverage_PaymentBy>;
...
const getCoverage_PaymentBySchema = (): z.ZodType<Coverage_PaymentBy> =>
...
export const CoverageSchemaInternal = z
  .object({
    ...
    insurancePlan: z.lazy(getReferenceSchema).optional(),
    insurer: z.lazy(getReferenceSchema).optional(),
    kind: z.enum(["insurance", "other", "self-pay"]),
    ...
    paymentBy: z.lazy(getCoverage_PaymentBySchema).array().optional(),
    ...
    subscriberId: z.lazy(getIdentifierSchema).array().optional(),

// Source: https://hl7.org/fhir/R5/explanationofbenefit-definitions.html#ExplanationOfBenefit.item
...
import type { ExplanationOfBenefit_Item_BodySite } from "./ExplanationOfBenefit_Item_BodySite";
import { ExplanationOfBenefit_Item_BodySiteSchemaInternal } from "./ExplanationOfBenefit_Item_BodySite";
...
import type { ExplanationOfBenefit_Item_ReviewOutcome } from "./ExplanationOfBenefit_Item_ReviewOutcome";
import { ExplanationOfBenefit_Item_ReviewOutcomeSchemaInternal } from "./ExplanationOfBenefit_Item_ReviewOutcome";
...
export interface ExplanationOfBenefit_Item extends BackboneElement {
  ...
  bodySite?: Array<ExplanationOfBenefit_Item_BodySite>;
  ...
  reviewOutcome?: ExplanationOfBenefit_Item_ReviewOutcome;
...
const getExplanationOfBenefit_Item_BodySiteSchema =
  (): z.ZodType<ExplanationOfBenefit_Item_BodySite> =>
...
const getExplanationOfBenefit_Item_ReviewOutcomeSchema =
  (): z.ZodType<ExplanationOfBenefit_Item_ReviewOutcome> =>
...
export const ExplanationOfBenefit_ItemSchemaInternal =
  BackboneElementSchemaInternal.extend({
    adjudication: z
      ...
      .optional(),
    bodySite: z
      .lazy(getExplanationOfBenefit_Item_BodySiteSchema)
      .array()
      .optional(),
    ...
    reviewOutcome: z
      .lazy(getExplanationOfBenefit_Item_ReviewOutcomeSchema)
      .optional(),

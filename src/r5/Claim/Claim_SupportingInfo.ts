// Source: https://hl7.org/fhir/R5/claim-definitions.html#Claim.supportingInfo
...
export interface Claim_SupportingInfo extends BackboneElement {
...
/** @internal */
export const Claim_SupportingInfoSchemaInternal =
    ...
    .superRefine((value, ctx) => {
      ...
      if (value_x_Present.length > 1) {
        ctx.addIssue({
          code: z.ZodIssueCode.custom,
          message:
            "Only one of valueAttachment, valueBoolean, valueIdentifier, valueQuantity, valueReference, valueString may be present for value[x]",
...
export const Claim_SupportingInfoSchema =

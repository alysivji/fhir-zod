// Source: https://hl7.org/fhir/R5/claim-definitions.html#Claim.event
...
export interface Claim_Event extends BackboneElement {
...
/** @internal */
export const Claim_EventSchemaInternal = BackboneElementSchemaInternal.extend({
  ...
  .superRefine((value, ctx) => {
    ...
    if (when_x_Present.length === 0) {
      ctx.addIssue({
        ...
        message: "One of whenDateTime, whenPeriod must be present for when[x]",
        path: ["whenDateTime"],
      });
    }
...
export const Claim_EventSchema =

// Source: https://hl7.org/fhir/R5/familymemberhistory.html
...
import type { FamilyMemberHistory_Participant } from "./FamilyMemberHistory_Participant";
import { FamilyMemberHistory_ParticipantSchemaInternal } from "./FamilyMemberHistory_Participant";
import type { FamilyMemberHistory_Procedure } from "./FamilyMemberHistory_Procedure";
import { FamilyMemberHistory_ProcedureSchemaInternal } from "./FamilyMemberHistory_Procedure";
...
export interface FamilyMemberHistory extends DomainResource {
  ...
  participant?: Array<FamilyMemberHistory_Participant>;
  ...
  procedure?: Array<FamilyMemberHistory_Procedure>;
...
const getFamilyMemberHistory_ParticipantSchema =
  (): z.ZodType<FamilyMemberHistory_Participant> =>
    FamilyMemberHistory_ParticipantSchemaInternal as z.ZodType<FamilyMemberHistory_Participant>;
const getFamilyMemberHistory_ProcedureSchema =
  (): z.ZodType<FamilyMemberHistory_Procedure> =>
...
/** @internal */
export const FamilyMemberHistorySchemaInternal = z
  .object({
    ...
    participant: z
      .lazy(getFamilyMemberHistory_ParticipantSchema)
      .array()
      .optional(),
    patient: z.lazy(getReferenceSchema),
    procedure: z
      .lazy(getFamilyMemberHistory_ProcedureSchema)
      .array()
      .optional(),

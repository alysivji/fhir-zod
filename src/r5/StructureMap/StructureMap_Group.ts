// Source: https://hl7.org/fhir/R5/structuremap-definitions.html#StructureMap.group
...
export const StructureMap_GroupSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    rule: z.lazy(getStructureMap_Group_RuleSchema).array().optional(),
    typeMode: z.enum(["type-and-types", "types"]).optional(),

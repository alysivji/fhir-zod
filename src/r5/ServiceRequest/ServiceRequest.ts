// Source: https://hl7.org/fhir/R5/servicerequest.html
...
import type { ServiceRequest_OrderDetail } from "./ServiceRequest_OrderDetail";
import { ServiceRequest_OrderDetailSchemaInternal } from "./ServiceRequest_OrderDetail";
import type { ServiceRequest_PatientInstruction } from "./ServiceRequest_PatientInstruction";
import { ServiceRequest_PatientInstructionSchemaInternal } from "./ServiceRequest_PatientInstruction";
...
export interface ServiceRequest extends DomainResource {
  ...
  orderDetail?: Array<ServiceRequest_OrderDetail>;
  /** Instructions in terms that are understood by the patient or consumer. */
  patientInstruction?: Array<ServiceRequest_PatientInstruction>;
...
const getServiceRequest_OrderDetailSchema =
  (): z.ZodType<ServiceRequest_OrderDetail> =>
    ServiceRequest_OrderDetailSchemaInternal as z.ZodType<ServiceRequest_OrderDetail>;
const getServiceRequest_PatientInstructionSchema =
  (): z.ZodType<ServiceRequest_PatientInstruction> =>
...
/** @internal */
export const ServiceRequestSchemaInternal = z
  .object({
    ...
    code: z.lazy(getCodeableReferenceSchema).optional(),
    ...
    location: z.lazy(getCodeableReferenceSchema).array().optional(),
    ...
    orderDetail: z.lazy(getServiceRequest_OrderDetailSchema).array().optional(),
    patientInstruction: z
      .lazy(getServiceRequest_PatientInstructionSchema)
      .array()
      .optional(),
    ...
    supportingInfo: z.lazy(getCodeableReferenceSchema).array().optional(),

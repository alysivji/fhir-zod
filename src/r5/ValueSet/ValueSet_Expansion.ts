// Source: https://hl7.org/fhir/R5/valueset-definitions.html#ValueSet.expansion
...
import type { ValueSet_Expansion_Property } from "./ValueSet_Expansion_Property";
import { ValueSet_Expansion_PropertySchemaInternal } from "./ValueSet_Expansion_Property";
...
export interface ValueSet_Expansion extends BackboneElement {
  ...
  property?: Array<ValueSet_Expansion_Property>;
...
const getValueSet_Expansion_PropertySchema =
  (): z.ZodType<ValueSet_Expansion_Property> =>
...
export const ValueSet_ExpansionSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    next: fhirUri().optional(),
    _next: z.lazy(getElementSchema).optional(),
    offset: z.number().int().optional(),
    _offset: z.lazy(getElementSchema).optional(),
    parameter: z.lazy(getValueSet_Expansion_ParameterSchema).array().optional(),
    property: z.lazy(getValueSet_Expansion_PropertySchema).array().optional(),

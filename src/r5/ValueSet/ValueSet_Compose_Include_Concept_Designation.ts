// Source: https://hl7.org/fhir/R5/valueset-definitions.html#ValueSet.compose.include.concept.designation
...
export const ValueSet_Compose_Include_Concept_DesignationSchemaInternal =
  BackboneElementSchemaInternal.extend({
    additionalUse: z.lazy(getCodingSchema).array().optional(),

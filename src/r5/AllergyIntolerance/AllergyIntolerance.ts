// Source: https://hl7.org/fhir/R5/allergyintolerance.html
...
import type { AllergyIntolerance_Participant } from "./AllergyIntolerance_Participant";
import { AllergyIntolerance_ParticipantSchemaInternal } from "./AllergyIntolerance_Participant";
...
export interface AllergyIntolerance extends DomainResource {
  ...
  participant?: Array<AllergyIntolerance_Participant>;
...
const getAllergyIntolerance_ParticipantSchema =
  (): z.ZodType<AllergyIntolerance_Participant> =>
    AllergyIntolerance_ParticipantSchemaInternal as z.ZodType<AllergyIntolerance_Participant>;
...
/** @internal */
export const AllergyIntoleranceSchemaInternal = z
  .object({
    category: z
    ...
    participant: z
      .lazy(getAllergyIntolerance_ParticipantSchema)
      .array()
      .optional(),

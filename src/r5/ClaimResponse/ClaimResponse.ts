// Source: https://hl7.org/fhir/R5/claimresponse.html
...
import type { ClaimResponse_Event } from "./ClaimResponse_Event";
import { ClaimResponse_EventSchemaInternal } from "./ClaimResponse_Event";
...
export interface ClaimResponse extends DomainResource {
  ...
  event?: Array<ClaimResponse_Event>;
...
const getClaimResponse_EventSchema = (): z.ZodType<ClaimResponse_Event> =>
...
export const ClaimResponseSchemaInternal = z
  .object({
    ...
    event: z.lazy(getClaimResponse_EventSchema).array().optional(),

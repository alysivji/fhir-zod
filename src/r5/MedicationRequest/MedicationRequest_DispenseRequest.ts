// Source: https://hl7.org/fhir/R5/medicationrequest-definitions.html#MedicationRequest.dispenseRequest
...
export const MedicationRequest_DispenseRequestSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    dispenser: z.lazy(getReferenceSchema).optional(),
    dispenserInstruction: z.lazy(getAnnotationSchema).array().optional(),
    doseAdministrationAid: z.lazy(getCodeableConceptSchema).optional(),

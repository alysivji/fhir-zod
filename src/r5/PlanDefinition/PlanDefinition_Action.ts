// Source: https://hl7.org/fhir/R5/plandefinition-definitions.html#PlanDefinition.action
...
import type { PlanDefinition_Action_Input } from "./PlanDefinition_Action_Input";
import { PlanDefinition_Action_InputSchemaInternal } from "./PlanDefinition_Action_Input";
import type { PlanDefinition_Action_Output } from "./PlanDefinition_Action_Output";
import { PlanDefinition_Action_OutputSchemaInternal } from "./PlanDefinition_Action_Output";
...
export interface PlanDefinition_Action extends BackboneElement {
  ...
  input?: Array<PlanDefinition_Action_Input>;
  ...
  output?: Array<PlanDefinition_Action_Output>;
...
const getPlanDefinition_Action_InputSchema =
  (): z.ZodType<PlanDefinition_Action_Input> =>
    PlanDefinition_Action_InputSchemaInternal as z.ZodType<PlanDefinition_Action_Input>;
const getPlanDefinition_Action_OutputSchema =
  (): z.ZodType<PlanDefinition_Action_Output> =>
    PlanDefinition_Action_OutputSchemaInternal as z.ZodType<PlanDefinition_Action_Output>;
...
export const PlanDefinition_ActionSchemaInternal =
  BackboneElementSchemaInternal.extend({
    ...
    input: z.lazy(getPlanDefinition_Action_InputSchema).array().optional(),
    linkId: fhirString().optional(),
    _linkId: z.lazy(getElementSchema).optional(),
    location: z.lazy(getCodeableReferenceSchema).optional(),
    output: z.lazy(getPlanDefinition_Action_OutputSchema).array().optional(),
    participant: z

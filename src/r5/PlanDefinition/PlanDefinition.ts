// Source: https://hl7.org/fhir/R5/plandefinition.html
...
import type { PlanDefinition_Action } from "./PlanDefinition_Action";
import { PlanDefinition_ActionSchemaInternal } from "./PlanDefinition_Action";
import type { PlanDefinition_Actor } from "./PlanDefinition_Actor";
import { PlanDefinition_ActorSchemaInternal } from "./PlanDefinition_Actor";
import type { PlanDefinition_Goal } from "./PlanDefinition_Goal";
import { PlanDefinition_GoalSchemaInternal } from "./PlanDefinition_Goal";
...
export interface PlanDefinition extends DomainResource {
  ...
  actor?: Array<PlanDefinition_Actor>;
...
const getPlanDefinition_ActorSchema = (): z.ZodType<PlanDefinition_Actor> =>
...
export const PlanDefinitionSchemaInternal = z
  .object({
    ...
    actor: z.lazy(getPlanDefinition_ActorSchema).array().optional(),

// Source: https://hl7.org/fhir/R5/coverageeligibilityrequest.html
...
import type { CoverageEligibilityRequest_Event } from "./CoverageEligibilityRequest_Event";
import { CoverageEligibilityRequest_EventSchemaInternal } from "./CoverageEligibilityRequest_Event";
...
export interface CoverageEligibilityRequest extends DomainResource {
  ...
  event?: Array<CoverageEligibilityRequest_Event>;
...
const getCoverageEligibilityRequest_EventSchema =
  (): z.ZodType<CoverageEligibilityRequest_Event> =>
    CoverageEligibilityRequest_EventSchemaInternal as z.ZodType<CoverageEligibilityRequest_Event>;
...
/** @internal */
export const CoverageEligibilityRequestSchemaInternal = z
  .object({
    contained: z.lazy(getFhirResourceSchema).array().optional(),
    created: fhirDateTime(),
    _created: z.lazy(getElementSchema).optional(),
    enterer: z.lazy(getReferenceSchema).optional(),
    event: z.lazy(getCoverageEligibilityRequest_EventSchema).array().optional(),

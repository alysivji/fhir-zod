// Source: https://hl7.org/fhir/R5/terminologycapabilities.html
...
export interface TerminologyCapabilities extends DomainResource {
  ...
  codeSearch?: "in-compose" | "in-compose-or-expansion" | "in-expansion";
...
/** @internal */
export const TerminologyCapabilitiesSchemaInternal = z
  .object({
    closure: z.lazy(getTerminologyCapabilities_ClosureSchema).optional(),
    codeSearch: z
      .enum(["in-compose", "in-compose-or-expansion", "in-expansion"])
      .optional(),

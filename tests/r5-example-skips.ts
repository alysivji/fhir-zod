...
//
// Current skips are all mirrored from the official HL7 R5 example pages, but
// they conflict with constraints emitted by this generator from the pinned R5
// StructureDefinitions. These are documented here so future work can trace
// whether each mismatch comes from:
...
export const r5ExampleSkips = new Map<string, string>([
	[
